...
teta_3_gorro_aux = lambda p_2 : fsolve(lambda a_2 : 1 - varphi_2(p_2,a_2) - r, 0.5)[0]

teta_1_gorro = lambda p_1 : min(1,(max(0,teta_1_gorro_aux(p_1))))
teta_2_gorro = lambda p_2 : min(1,(max(0,teta_2_gorro_aux(p_2))))
teta_3_gorro = lambda p_2: min(1,(max(0,teta_3_gorro_aux(p_2))))
...
def teta_2_tilde(p_2):
     tet_tild = fsolve(lambda a_2 : varphi_2(p_2,a_2)/p_2 - (1-varphi_2(p_2,a_2))/r, 0.5)[0]
     tet_tild = min(max(tet_tild,0),1)
     return tet_tild
teta_1_tilde_aux = lambda p_1,p_2: inv_alfa(teta_2_tilde(p_2),p_1,p_2)
teta_1_tilde = lambda p_1,p_2: min(teta_1_tilde_aux(p_1,p_2),1)
...
f_aux_1 = lambda p_1 : max(teta_1_gorro(p_1),teta_1_barra)
f_aux_2 = lambda p_2 : max(teta_2_gorro(p_2),teta_2_barra)
f_3 = lambda p_1,p_2 : (1-f_aux_1(p_1))*(1-F_2(teta_2_barra))
f_1_tilde_aux = lambda p_1,p_2: max(teta_1_barra, inv_alfa(teta_2_barra,p_1,p_2))
f_1_tilde = lambda p_1,p_2: max(f_1_tilde_aux(p_1,p_2), teta_1_tilde(p_1,p_2))
f_2_tilde = lambda p_2: max(teta_2_barra,teta_2_tilde(p_2))
f_3_tilde = lambda p_2: min(teta_3_barra,teta_2_tilde(p_2))
def f_4(p_1,p_2):
    integrando = lambda a_1,a_2 : f_1(a_1)*f_2(a_2)
    lim_inf_1 = f_aux_1(p_1)
    ...
    return int_f_4
f_5 = lambda p_2: min(teta_3_gorro(p_2), teta_3_barra)
def f_6(p_1,p_2):
    integrando = lambda a_1,a_2 : f_1(a_1)*f_2(a_2)
    lim_inf_1 = f_aux_1(p_1)
    lim_sup_1 = min(inv_beta(0,p_1,p_2),1)
    lim_inf_2 = lambda a_1 : 0
    lim_sup_2 = lambda a_1 : min(beta(a_1,p_1,p_2),teta_3_barra)
...
def f_7(p_1,p_2):
    ...
    lim_inf_1 = f_aux_1(p_1)
    lim_sup_1 = min(inv_alfa(1,p_1,p_2),1)
    lim_inf_2 = lambda a_1 : max(f_2_tilde(p_2),alfa(a_1,p_1,p_2))
    lim_sup_2 = lambda a_1 : 1
...
def f_8(p_1,p_2):
    ...
    lim_sup_1 = min(inv_beta(0,p_1,p_2),1)
    lim_inf_2 = lambda a_1 : 0
    lim_sup_2 = lambda a_1 : min(beta(a_1,p_1,p_2), f_3_tilde(p_2))
...
def H_3(p_1,p_2):
    if beta(1,p_1,p_2) >= teta_3_barra:
        h_3 = (1-f_aux_1(p_1))*F_2(f_5(p_2))
    elif inv_beta(0,p_1,p_2) <= teta_1_barra:
        h_3 = 0
    else:
        h_3 = f_6(p_1,p_2)
    return h_3
...
d_2 = lambda p_1,p_2: F_1(f_aux_1(p_1))*(1-F_2(f_aux_2(p_2))) + H_2(p_1,p_2)
d_3 = lambda p_1,p_2: F_1(f_aux_1(p_1))*F_2(f_5(p_2)) + H_3(p_1,p_2)
d_1 = lambda p_1,p_2: 1 - d_2(p_1,p_2) - d_3(p_1,p_2) - (F_2(f_aux_2(p_2)) - F_2(f_5(p_2)))*F_1(f_aux_1(p_1))

#Demandas con teta_2_gorro < teta_3_gorro
def J_2(p_1,p_2):
    if alfa(1,p_1,p_2) <= f_2_tilde(p_2):
        j_2 = (1-F_2(f_2_tilde(p_2)))*(1-f_aux_1(p_1))
    elif inv_alfa(1,p_1,p_2) <= teta_1_barra:
        j_2 = 0
    else:
        j_2 = f_7(p_1,p_2)
...
def J_3(p_1,p_2):
    if beta(1,p_1,p_2) >= f_3_tilde(p_2):
        j_3 = (F_2(f_3_tilde(p_2)))*(1-f_aux_1(p_1))
    elif inv_beta(1,p_1,p_2) <= teta_1_barra:
        j_3 = 0
    else:
        j_3 = f_8(p_1,p_2)
    return j_3

D_2 = lambda p_1,p_2: F_1(f_aux_1(p_1))*(1-F_2(f_2_tilde(p_2))) + J_2(p_1,p_2)
D_3 = lambda p_1,p_2: F_1(f_aux_1(p_1))*F_2(f_3_tilde(p_2)) + J_3(p_1,p_2)
D_1 = lambda p_1,p_2: 1- D_2(p_1,p_2) - D_3(p_1,p_2) - F_1(f_aux_1(p_1))*(min(0, F_2(teta_2_barra) - F_2(teta_2_tilde(p_2))) + min(F_2(teta_2_tilde(p_2))-F_2(teta_3_barra),0))

#Demandas en caso general
def Demanda_2(p_1,p_2):
    if teta_3_gorro(p_2) <= teta_2_gorro(p_2):
        Dem_2 = d_2(p_1,p_2)
    else:
        Dem_2 = D_2(p_1,p_2)
    return Dem_2

def Demanda_3(p_1,p_2):
    if teta_3_gorro(p_2) <= teta_2_gorro(p_2):
        Dem_3 = d_3(p_1,p_2)
    else:
        Dem_3 = D_3(p_1,p_2)
...
u_3 = lambda s,p_2 : s*(r - K(p_2))

def R(p_1,p_2):
    R_op = u_3(r, Demanda_3(p_1,p_2)/r, p_2)
    return R_op
...
def p_1_mej_resp(p_2):
    deman_1 = lambda p_1 : Demanda_1(p_1,p_2)-b_1
    a = fsolve(deman_1,0.6)[0]
    return a

def p_2_mej_resp(p_1):
    deman_2 = lambda p_2 : Demanda_2(p_1,p_2)-b_2
    a = fsolve(deman_2,0.6)[0]
    return a

def H(x):
    H_1 = p_1_mej_resp(x[1]) - x[0]
    H_2 = p_2_mej_resp(x[0]) - x[1]
...
if __name__ == '__main__':
    ...
    for i in return_dict:
        ...
        #r = x[2]
        #print(return_dict[i])
        if b_1<= p_1 <=1 and b_2<= p_2 <=1:
            lista_equilibrios.append(return_dict[i])


    print(lista_equilibrios)

    print("ES ESTE con r = 0.5 y b_1 = b_2 = 0.4 y funciones de demanda bien! y otras cond de mjr rpta 0.6 y más cond inic para la H")
